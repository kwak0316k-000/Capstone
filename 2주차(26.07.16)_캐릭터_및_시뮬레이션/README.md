...
6. **6차 시도(최종)**: "거울상" 지시를 완전히 빼고, 오른쪽·왼쪽 옆모습을 각각 독립적으로 서술했다 — 예: "오른쪽 옆모습은 앞머리가 눈썹을 거의 덮을 정도, 왼쪽 옆모습은 눈썹이 뚜렷하게 보임"처럼 비대칭 자체를 구체적으로 지정. 가방도 "오른쪽 옆모습에서만 뚜렷이 보이고, 왼쪽 옆모습에서는 몸에 가려 안 보이거나 끈만 살짝"이라고 명시했다. 김재성의 목에 건 유선 이어폰도 이 과정에서 어색하다는 피드백을 받아 무선 이어버드(에어팟 스타일)로 교체했다.

**배운 점 (갱신)**: 이미지 생성 프롬프트에서 "왼쪽/오른쪽을 다르게 그려라"는 지시는 두 가지 전혀 다른 요구를 뭉뚱그릴 위험이 있다 — ①단순히 "같은 방향을 보지 않게" 하는 것과 ②"실제로 다른 쪽 얼굴의 물리적 디테일(가르마, 액세서리 위치)까지 정확히 반영"하는 것은 다르다. ①만 신경 쓰고 "거울상으로 만들라"고 지시하면 방향은 고쳐지지만 ②를 깨버린다. 좌우 비대칭 요소(헤어 파팅, 한쪽 어깨 가방, 한쪽 귀 액세서리 등)가 있는 캐릭터라면, 두 옆모습을 절대 서로의 변형으로 설명하지 말고 처음부터 완전히 독립적으로, 각 요소가 "이 각도에서는 보이는지/안 보이는지"까지 명시해야 한다.
